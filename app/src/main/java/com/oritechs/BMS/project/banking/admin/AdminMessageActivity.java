...
public class AdminMessageActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    messageView.setText(getResources().getString(R.string.message_owner) + " " + adminName);
    ...
    messagesView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
      ...
      public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        Intent intentResult = new Intent(AdminMessageActivity.this,
  ...
  public void updateList() {
    ...
    HashMap<Integer, Boolean> messages = db.getAllMessagesHashMap(adminId);
    ...
    // basically keys for the message info and its respective text views
