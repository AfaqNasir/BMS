...
public class ManagerViewItsMessagesActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.activity_manager_view_its_messages);

    // get manager id from intent
    intent = getIntent();
    ...
    messagesView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
      ...
      public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        Intent intentResult = new Intent(ManagerViewItsMessagesActivity.this,
